...
75的含义是3×(num_class+4+1)，这是对应voc数据集，有20个类别。20指的是20个类别的概率，4指对先验框的中心点和长宽的修正量，1指这个框内有没有物体。因为每个格子都有3个先验框框，所以再乘3。如果使用coco数据集，有80个类别，那么对应的维度就是3×(80+4+1)=255。
...
<div align="center">
<img src="assets/4.jpg" width="800">
</div>
